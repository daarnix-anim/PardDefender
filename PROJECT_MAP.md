...
Файлов: **29** · связей: **57** · собрано: 2026-08-29 09:55
...
`extension/com.pard.defender/host/PardDefenderPlan.jsx` · 562 строк · работает
...
`extension/com.pard.defender/client/main.js` · 2444 строк · работает
...
`tests/host.test.js` · 910 строк · работает

163 проверки хоста: рабочая папка, ветки, маршруты, секвенции, границы раскладки.
