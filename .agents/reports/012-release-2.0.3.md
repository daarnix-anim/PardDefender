...
| `tests/host.test.js`, `tests/mock-ae.js` | Добавлены моки `COMP_CROPPED_LAYERS`, `replaceSource`, `locked`, `position`/`anchorPoint`, 18 новых тестов PSD. | 100% тестовое покрытие сопоставления слоёв и переноса PSD. |
...
| `node tests/run-all.js` | 0 | Все 12 наборов пройдены (845 проверок, 0 провалов) |
